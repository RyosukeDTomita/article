...
## なぜ、Torは発信者を特定しづらくするのか
Torは3つの中継地点を経由して目的のウェブサイトに到達するようになっており、中継地点ごとにIPアドレスが変わるようになっている。
そのため、発信者

プロバイダ開示請求を何度も行う必要がある。
特に、海外のサーバに対してプロバイダ開示請求を行なっても、無視されたり開示請求までに時間がかかるためログが消失してしまう可能性もあり、torの追跡は難しい。
## vpn vs proxy
### VPN
...
<html>
    ...
    <body>
        <a href="https://www.youtube.com/channel/UCesAzmQTTBiY6Yq1vrt2pCw">世界をおおいに盛り上げるためのスーパーハッカー</a>
    <body>
</html>
```
